...
class AccountInformationScreen extends StatelessWidget {
          ...
          builder: (profileController) => Scaffold(
            ...
            body: Column(
              children: [
                    ...
                    child: SingleChildScrollView(
                      child: Form(
                        ...
                        child: Column(
                          ...
                          children: [
                            _buildUserImage(profileController),
                            _buildFirstNameField(profileController),
                            _buildLastNameField(profileController),
                            _buildEmailField(profileController),
                            _buildPostCodeField(profileController),
                          ],
                ...
                _buildUpdateButton(profileController)
              ],
            ),
          ),
        ));
  ...
  Widget _buildUpdateButton(ProfileController profileController) {
    return CustomButton(
      onTap: () async {
  ...
  Widget _buildPostCodeField(ProfileController profileController) {
  ...
  Widget _buildEmailField(ProfileController profileController) {
    return customTextFormField(
  ...
  Widget _buildLastNameField(ProfileController profileController) {
    return customTextFormField(
  ...
  Widget _buildFirstNameField(ProfileController profileController) {
    return customTextFormField(
  ...
  Widget _buildUserImage(ProfileController profileController) {
    return Align(
