...
class AddVehicleDetailsScreen extends StatelessWidget {
    ...
    return CustomAnnotatedRegions(
      ...
      child: GetX<VehicleDetailController>(
        init: VehicleDetailController(
          name: screenName,
          fetchData: screenName == AppString.editScreenFlag ? vehicleData! : Vehicle(),
        ),
              ...
              child: Form(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _buildTransmissionTypeField(context, vehicleDetailController),
  ...
  Widget _buildSubmitBtn(VehicleDetailController vehicleDetailController) {
    return Align(
      ...
      child: CustomButton(
        onTap: () async {
          screenName == AppString.editScreenFlag ? await vehicleDetailController.editVehicleApi() : await vehicleDetailController.addVehicleApi();
        },
  ...
  Widget _buildFuelTypeField(BuildContext context, VehicleDetailController vehicleDetailController) {
  ...
  Widget _buildTransmissionTypeField(BuildContext context, VehicleDetailController vehicleDetailController) {
    return selectionTextField(
      context,
  ...
  Widget _buildVehicleModelField(BuildContext context, VehicleDetailController vehicleDetailController) {
    return selectionTextField(
      context,
  ...
  Widget _buildVehicleMakeField(BuildContext context, VehicleDetailController vehicleDetailController) {
    return selectionTextField(
      context,
  ...
  Widget _buildVehicleYearField(VehicleDetailController vehicleDetailController) {
  ...
  Widget _buildVehicleNumberField(VehicleDetailController vehicleDetailController) {
    return customTextFormField(
      ...
      children: [
        ...
        DropdownButtonFormField2<String>(
          ...
          customButton: Row(
            children: [
              AppText(
                text: selectedVal.value.isNotEmpty ? selectedVal.value : '${AppString.select} $text',
                fontSize: 16.sp,
                fontWeight: FontWeight.w500,
                color: AppColors.blackColor,
              ),
