class CreateNewAccountModel {
  ...
  CreateNewAccountModel({this.apiresponse});

  CreateNewAccountModel.fromJson(Map<String, dynamic> json) {
...
class Data {
  ...
  Data.fromJson(Map<String, dynamic> json) {
    ...
    forgotPasswordVerify = json['forgotPasswordVerify'];
  ...
  Map<String, dynamic> toJson() {
    ...
    data['forgotPasswordVerify'] = this.forgotPasswordVerify;
