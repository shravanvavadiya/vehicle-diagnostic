        ...
        ? homeController.getAllVehicleList!.apiresponse!.data!.vehicle!.isEmpty
            ...
            : ListView.builder(
                ...
                itemCount: homeController
                    .getAllVehicleList!.apiresponse!.data!.vehicle!.length,
                itemBuilder: (context, index) {
                  return HomeScreenComponent(
                      getVehicleData: homeController.getAllVehicleList!
                          .apiresponse!.data!.vehicle![index]);
                },
              )
        : Center(
            child: CircularProgressIndicator(
              ...
              Column(
                ...
                children: [
                  ...
                  SizedBox(
                    ...
                    child: AppText(
                      text:
                          "${homeController.getUserProfileModel.value.profileResponse?.profileData?.firstName ?? ""} "
                ...
                child: Container(
                    ...
                    child: ClipRRect(
                      ...
                      child: CachedNetworkImage(
                        ...
                        /// TODO : image Change
                        imageUrl: homeController.getUserProfileModel.value
                                .profileResponse?.profileData!.photo ??
                            "",
                        fit: BoxFit.cover,
